...
List<RouteBase> buildFullscreenRoutes(GlobalKey<NavigatorState> rootKey) {
  ...
  return [
    ...
    fs('/sub-recipes', (c, s) => const SubRecipesScreen()),
    fs(
      '/sub-recipe/:id',
    ...
    fs('/notebook/cards', (c, s) => const LessonCardsScreen()),
    fs('/notebook/notes', (c, s) => const NotesScreen()),
    fs('/notebook/diary', (c, s) => const DiaryScreen()),
    fs('/notebook/versions', (c, s) => const VersionsScreen()),
    fs('/notebook/logs', (c, s) => const ProcessLogsScreen()),
    fs(
      '/notebook/repertoire/:kind',
