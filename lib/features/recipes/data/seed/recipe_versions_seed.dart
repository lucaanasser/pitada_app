    ...
    components: [
      RecipeComponent(
        ingredients: [
          ...
          Ingredient(
              name: 'Shoyu', grams: 60, humanQty: 4, humanUnit: 'c. sopa',),
          Ingredient(
            name: 'Amendoim',
            grams: 40,
            humanQty: 0.3,
        ...
        steps: [
          RecipeStep(
              text: 'Corte o frango em cubos e pique o pimentão e o alho.',),
          RecipeStep(
            text:
          ...
          RecipeStep(
              text: 'Acerte o sal com o shoyu e finalize com o amendoim.',),
        ],
      ),
    ],
  ),
    ...
    components: [
      RecipeComponent(
        ...
        steps: [
          ...
          RecipeStep(
            text:
                'Sele os cubos em LEVAS, sem lotar a panela, até criar crosta.',
  ...
  Recipe(
    ...
    components: [
      RecipeComponent(
        ingredients: [
          Ingredient(
              name: 'Alcatra', grams: 500, humanQty: 500, humanUnit: 'g',),
          Ingredient(
            name: 'Creme de leite',
            grams: 200,
            humanQty: 1,
          ...
          Ingredient(
              name: 'Champignon', grams: 80, humanQty: 80, humanUnit: 'g',),
        ],
        steps: [
