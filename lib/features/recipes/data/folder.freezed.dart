...
mixin _$Folder {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, heroColor);

  @override
  String toString() {
    return 'Folder(id: $id, name: $name, heroColor: $heroColor)';
  }
}
...
abstract mixin class $FolderCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String heroColor});
}
...
extension FolderPatterns on Folder {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String name, String heroColor)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Folder() when $default != null:
        return $default(_that.id, _that.name, _that.heroColor);
      case _:
        return orElse();
    }
  }
...
class _Folder implements Folder {
  const _Folder(
      {required this.id, required this.name, this.heroColor = 'clay'});
