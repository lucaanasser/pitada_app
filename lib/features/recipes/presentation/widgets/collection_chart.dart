...
//            aba Receitas, com a fração cozinhada em % no miolo. Espelho
//            anti-acúmulo: a parte cheia só sobe e a parte vazia é convite
//            ("esperando estreia"), nunca dívida. HOJE com dados mockados.
...
class CollectionChart extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final fraction = total == 0 ? 0.0 : cooked / total;
