...
class _DiaryQuickSheet extends StatefulWidget {
  const _DiaryQuickSheet({this.recipeName});

  final String? recipeName;

  @override
  State<_DiaryQuickSheet> createState() => _DiaryQuickSheetState();
}

class _DiaryQuickSheetState extends State<_DiaryQuickSheet> {
  ...
  /// Loga a entrada, fecha o sheet e confirma com um SnackBar.
  /// Usada por: o botão "Salvar no diário".
  void _save() {
